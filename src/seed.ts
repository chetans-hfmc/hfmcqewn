...
const AXES: AxisDef[] = [
  ...
  { id: "segment", name: "Segment", values: [{ v: "ELITE", l: "Elite" }, { v: "PREMIER", l: "Premier" }, { v: "STANDARD", l: "Standard" }, { v: "EXCELLENCY", l: "Excellency" }, { v: "THARWA", l: "Tharwa" }, { v: "PRIV", l: "Private" }, { v: "PERSONAL", l: "Personal Banking" }, { v: "ASPIRE", l: "Aspire / Privilege" }, { v: "HOMESAVER", l: "Home Saver" }, { v: "EMIRATI", l: "Emirati Customer" }] },
...
const PRODUCT_DEFS: ProductDef[] = [
  ...
  /* ---------------- FAB · Salaried (Conventional) ---------------- */
  {
    id: "pd-fab-sal", bankId: "b-fab", name: "Home Loan — Salaried", loanType: "CONVENTIONAL",
    classes: ["SALARIED", "SELF_EMPLOYED"], txTypes: ["PURCHASE", "RESALE", "BUYOUT", "BUYOUT_EQUITY", "EQUITY"],
    axes: ["employment", "tenure", "stl"],
    tags: ["Salaried", "SE"], createdAt: ts(-60), createdBy: "hfmm-15",
    versions: [pv({
      version: 1, status: "ACTIVE", effectiveFrom: d(-60), source: "FAB salaried pricing card",
      eligibility: {
        minSalary: 15000, minLoan: 750000, maxLoan: 20000000, maxAgeSalaried: 65, maxAgeSelfEmp: 70,
        minLosMonths: 3,
        incomeRecognition: { rentalPct: 83, bonusPct: 0, commissionPct: 75 },
        ltvMatrix: { "NATIONAL:1": 85, "EXPAT:1": 80, "EXPAT:2": 65 },
        highRiskBands: [{ ltv: 60, sectors: ["Aviation", "Real Estate", "Hospitality", "Construction"] }],
        gates: [
          { id: "g1", kind: "FLAG", label: "Bonus not considered", hardStop: false },
          { id: "g2", kind: "FLAG", label: "US-sanctioned countries restricted", hardStop: false },
          { id: "g3", kind: "FLAG", label: "Conventional min AED 750k (Islamic min 1M); min loan to be booked Islamic-only", hardStop: false },
          { id: "g4", kind: "FLAG", label: "Loan > AED 2M requires site visit", hardStop: false },
          { id: "g5", kind: "FLAG", label: "Housing allowance: 25% basic (CAT A, proof) / 100% if value mentioned; direct-to-landlord 100% with proof", hardStop: false },
        ],
        notes: [
          "FAB Elite: exceptional basis, min AED 5M, upfront approval.",
          "Additional income on borderline DBR at final approval, subject to credit.",
          "MortgageOne/SaadiqOne: 25% offset option, nil fee.",
          "Age at maturity cannot exceed 75 years.",
        ],
      },
      tenure: { maxMonths: 300 },
      grid: { cells: [
        { id: "f1", key: { employment: "SALARIED", tenure: "1", stl: "STL" }, structure: "FIXED_THEN_VAR", fixedRate: 3.99, fixedMonths: 12, followOn: { margin: 1.5, index: "EIBOR_3M", floor: 1.99 } },
        { id: "f2", key: { employment: "SALARIED", tenure: "2", stl: "STL" }, structure: "FIXED_THEN_VAR", fixedRate: 3.99, fixedMonths: 24, followOn: { margin: 1.5, index: "EIBOR_3M", floor: 1.99 } },
        { id: "f3", key: { employment: "SALARIED", tenure: "3", stl: "STL" }, structure: "FIXED_THEN_VAR", fixedRate: 3.99, fixedMonths: 36, followOn: { margin: 1.5, index: "EIBOR_3M", floor: 1.99 } },
        { id: "f5", key: { employment: "SALARIED", tenure: "5", stl: "STL" }, structure: "FIXED_THEN_VAR", fixedRate: 4.19, fixedMonths: 60, followOn: { margin: 1.5, index: "EIBOR_3M", floor: 1.99 } },
        { id: "fn2", key: { employment: "SALARIED", tenure: "2", stl: "NSTL" }, structure: "FIXED_THEN_VAR", fixedRate: 4.24, fixedMonths: 24, followOn: { margin: 1.89, index: "EIBOR_3M", floor: 1.99 } },
        { id: "fn3", key: { employment: "SALARIED", tenure: "3", stl: "NSTL" }, structure: "FIXED_THEN_VAR", fixedRate: 4.24, fixedMonths: 36, followOn: { margin: 1.89, index: "EIBOR_3M", floor: 1.99 } },
        { id: "fn5", key: { employment: "SALARIED", tenure: "5", stl: "NSTL" }, structure: "FIXED_THEN_VAR", fixedRate: 4.44, fixedMonths: 60, followOn: { margin: 1.89, index: "EIBOR_3M", floor: 1.99 } },
      ]},
      fees: {
        processingPct: 0.5, processingMin: 0, processingMax: 25000, valuation: 3150, preApproval: 0, vatPct: 5,
        earlySettlement: "1% + VAT of outstanding or AED 10,000 + VAT — whichever lower (refund up to AED 10,000 charged by other bank after disbursal)",
        partialSettlement: "1.05% of outstanding (max AED 10,500 or less)",
        lifeInsurancePct: 0.0112, lifeInsuranceBasis: "PM", lifeInsuranceNote: "per month of outstanding; life insurance optional",
        propertyInsuranceNote: "On individual basis",
        processingFeeTiers: [
          { label: "Buyout", pct: 0 }, { label: "Residential & Investment", pct: 0.5 },
          { label: "Estate Finance & Non-residents", pct: 1.0 }, { label: "Top up (incremental)", pct: 1.0 },
          { label: "STL waiver / NSTL 0.25%", pct: 0.25 },
        ],
        feeFinancing: { allowed: false },
        rateAdjustments: [
          { id: "fa1", label: "Cash release > AED 300k", bps: 25, txTypes: ["EQUITY"], loanGt: 300000 },
          { id: "fa2", label: "Cash release > AED 500k", bps: 50, txTypes: ["EQUITY"], loanGt: 500000 },
          { id: "fa3", label: "Age above standard offering (expat 65 / SE & National 70)", bps: 25, ageGt: 65 },
        ],
        note: "DBR computed with 2% of credit card limit",
      },
      affordability: { maxDBR: 50, ccPct: 2, rentalPct: 83, bonusPct: 0, stressAddPct: 2 },
      documents: [
        { name: "Passport, Visa & EID (PDF)", required: true }, { name: "Application form (e-signed)", required: true },
        { name: "Salary certificate (within 30 days)", required: true }, { name: "Payslips — 6 months (if salary varies)", required: false },
        { name: "Bank statements — 3 months (e-statements)", required: true }, { name: "Latest CC / liability statements", required: true },
        { name: "Title deed & MOU copy (final approval)", required: false }, { name: "Floor plan copy (final approval)", required: false },
      ],
      tat: { paDays: 3, valuationDays: 3, folDays: 3, totalDays: 20, paValidityDays: 60, folValidityDays: 60, valuationValidityDays: 60, accountOpeningDays: 1, disbursalDays: 5, transferDays: 2 },
    })],
  },
  /* ---------------- HSBC · Salaried (Islamic) ---------------- */
  {
    id: "pd-hsbc-sal", bankId: "b-hsbc", name: "Home Loan — Salaried", loanType: "ISLAMIC",
    classes: ["SALARIED"], txTypes: ["PURCHASE", "RESALE", "BUYOUT", "EQUITY"],
    axes: ["segment", "residency", "relationship", "tenure"],
    tags: ["Salaried", "Segment-priced"], createdAt: ts(-60), createdBy: "hfmm-15",
    versions: [pv({
      version: 1, status: "ACTIVE", effectiveFrom: d(-60), source: "HSBC salaried pricing (Premier/GPB)",
      eligibility: {
        minSalary: 15000, minLoan: 350000, maxLoan: 35000000, maxAgeSalaried: 65,
        minLosMonths: 3,
        incomeRecognition: { rentalPct: 82, bonusPct: 50, commissionPct: 0 },
        ltvMatrix: { "NATIONAL:1": 85, "EXPAT:1": 80, "EXPAT:2": 65 },
        secondPropertyLtv: 75,
        highRiskBands: [{ ltv: 60, nationalities: ["Iran"], sectors: [] }],
        gates: [
          { id: "g1", kind: "NATIONALITY_BLOCK", label: "Russian — resident & non-resident restricted", values: ["RUSSIA"], hardStop: true },
          { id: "g2", kind: "FLAG", label: "REA not financed (developer does) / Salon & Spa restricted", hardStop: false },
          { id: "g3", kind: "FLAG", label: "Commission/variable/flying allowance not considered; 100% accommodation allowance for airlines", hardStop: false },
          { id: "g4", kind: "FLAG", label: "Co-applicant liabilities considered even if income not included", hardStop: false },
          { id: "g5", kind: "FLAG", label: "HSBC gives 75% LTV if client has/had any UAE property (mortgaged or not)", hardStop: false },
        ],
        notes: [
          "UAE National eligible for Premier segment rate (Emirati proposition).",
          "HSBC UAE staff: 10bps lower; ETB Premier-funded (TRB ≥ 500K): 10bps discount.",
          "Top-ups & ERL: +25bps from standard segment rate.",
          "Proof of downpayment: 3-month source proof.",
        ],
      },
      tenure: { maxMonths: 300 },
      grid: { cells: [
        { id: "h1", key: { segment: "PREMIER", tenure: "1" }, structure: "FIXED_THEN_VAR", fixedRate: 4.05, fixedMonths: 12, followOn: { margin: 0.99, index: "EIBOR_3M" } },
        { id: "h2", key: { segment: "PREMIER", tenure: "2" }, structure: "FIXED_THEN_VAR", fixedRate: 4.19, fixedMonths: 24, followOn: { margin: 1.29, index: "EIBOR_3M" } },
        { id: "h3", key: { segment: "PREMIER", tenure: "3" }, structure: "FIXED_THEN_VAR", fixedRate: 4.39, fixedMonths: 36, followOn: { margin: 1.69, index: "EIBOR_3M" } },
        { id: "h5", key: { segment: "PREMIER", tenure: "5" }, structure: "FIXED_THEN_VAR", fixedRate: 5.05, fixedMonths: 60, followOn: { margin: 1.69, index: "EIBOR_3M" } },
        { id: "hn1", key: { segment: "PERSONAL", tenure: "1" }, structure: "FIXED_THEN_VAR", fixedRate: 4.79, fixedMonths: 12, followOn: { margin: 1.62, index: "EIBOR_3M" } },
        { id: "hn2", key: { segment: "PERSONAL", tenure: "2" }, structure: "FIXED_THEN_VAR", fixedRate: 3.99, fixedMonths: 24, followOn: { margin: 1.62, index: "EIBOR_3M" } },
        { id: "hn3", key: { segment: "PERSONAL", tenure: "3" }, structure: "FIXED_THEN_VAR", fixedRate: 4.15, fixedMonths: 36, followOn: { margin: 1.62, index: "EIBOR_3M" } },
        { id: "hn5", key: { segment: "PERSONAL", tenure: "5" }, structure: "FIXED_THEN_VAR", fixedRate: 4.99, fixedMonths: 60, followOn: { margin: 1.62, index: "EIBOR_3M" } },
      ]},
      fees: {
        processingPct: 1, processingMin: 5000, valuation: 2625, preApproval: 0, vatPct: 5,
        earlySettlement: "1.05% of outstanding (incl. VAT) or AED 10,500 — whichever lower; no fee after 7 years",
        partialSettlement: "Up to 25% every year",
        lifeInsuranceNote: "Independent with Zurich (through bank only)",
        propertyInsurancePct: 0.06, propertyInsuranceBasis: "PA", propertyInsuranceNote: "per annum",
        processingFeeTiers: [
          { label: "Private & Premier (non-BT)", pct: 0.5 }, { label: "Advance & Personal (non-BT)", pct: 1.0 },
          { label: "Balance Transfer", pct: 0 },
        ],
        feeFinancing: { allowed: true, basis: "Fee finance available" },
        note: "Valuation fee refund AED 2,625 for balance transfer after drawdown & TD lien",
      },
      affordability: { maxDBR: 50, ccPct: 5, rentalPct: 82, bonusPct: 50, stressAddPct: 2 },
      documents: [
        { name: "Passport, Visa & EID (PDF)", required: true }, { name: "Application form (e-signed)", required: true },
        { name: "Etihad Credit consent (original if AIP)", required: true }, { name: "Salary certificate (within 30 days, addressed to bank)", required: true },
        { name: "Payslips — 3 months (if salary varies)", required: false }, { name: "Bank statements — 6 months (e-statements)", required: true },
        { name: "Latest CC / liability statements", required: true }, { name: "Proof of downpayment (3-month source)", required: true },
      ],
      tat: { paDays: 1, valuationDays: 3, folDays: 3, totalDays: 15, paValidityDays: 60, folValidityDays: 30, valuationValidityDays: 60, accountOpeningDays: 1, disbursalDays: 5, transferDays: 2 },
    })],
  },
  /* ---------------- Mashreq · Salaried Campaign (Apr 2026 pricing) ---------------- */
  {
    id: "pd-mash-campaign", bankId: "b-mashreq", name: "Home Loan — Salaried (Apr 2026 Campaign)", loanType: "CONVENTIONAL",
    classes: ["SALARIED"], txTypes: ["PURCHASE", "RESALE", "BUYOUT", "EQUITY"],
    axes: ["segment", "employment", "tenure", "residency"],
    tags: ["Salaried", "Campaign"], createdAt: ts(-60), createdBy: "hfmm-15",
    versions: [pv({
      version: 1, status: "ACTIVE", effectiveFrom: "2026-04-01", source: "Mashreq salaried pricing campaign — logged 1–30 Apr 2026",
      eligibility: {
        minSalary: 15000, minLoan: 100000, maxLoan: 10000000, maxAgeSalaried: 65,
        minLosMonths: 6,
        incomeRecognition: { rentalPct: 83, bonusPct: 100, commissionPct: 50 },
        ltvMatrix: { "NATIONAL:1": 85, "EXPAT:1": 80, "EXPAT:2": 65 },
        highRiskBands: [{ ltv: 50, sectors: [], nationalities: ["Iran"] }],
        gates: [
          { id: "g1", kind: "FLAG", label: "Premium segment: salary transfer ≥ AED 50k/month AND loan ≥ AED 3.5M (else Standard)", hardStop: false },
          { id: "g2", kind: "FLAG", label: "Exposure > AED 15M: case-to-case pricing, business concurrence", hardStop: false },
          { id: "g3", kind: "FLAG", label: "Rental income > business/salary income: +100bps pricing", hardStop: false },
          { id: "g4", kind: "FLAG", label: "Alcohol & tobacco trading cannot be booked under Islamic Finance", hardStop: false },
        ],
        notes: [
          "POL & FOL validity 30 days for all fixed-rate cases.",
          "Guaranteed bonus 100% (2-yr proof); guaranteed commission 50% (6-mth avg).",
          "AECB taken upfront; customer born in Iran on any passport cannot be logged.",
        ],
      },
      tenure: { maxMonths: 300 },
      grid: { cells: [
        { id: "m1", key: { segment: "PREMIER", employment: "SALARIED", tenure: "2", stl: "STL" }, structure: "FIXED_THEN_VAR", fixedRate: 3.99, fixedMonths: 24, followOn: { margin: 1.49, index: "EIBOR_3M", floor: 3.99 } },
        { id: "m2", key: { segment: "STANDARD", employment: "SALARIED", tenure: "2", stl: "STL" }, structure: "FIXED_THEN_VAR", fixedRate: 4.49, fixedMonths: 24, followOn: { margin: 1.49, index: "EIBOR_3M", floor: 3.99 } },
        { id: "m3", key: { segment: "PREMIER", employment: "SELF_EMPLOYED", tenure: "2" }, structure: "FIXED_THEN_VAR", fixedRate: 4.99, fixedMonths: 24, followOn: { margin: 2.25, index: "EIBOR_3M", floor: 4.99 }, note: "Premium low-doc/SE (SEMT)" },
        { id: "m4", key: { segment: "STANDARD", employment: "SELF_EMPLOYED", tenure: "2" }, structure: "FIXED_THEN_VAR", fixedRate: 5.25, fixedMonths: 24, followOn: { margin: 2.25, index: "EIBOR_3M", floor: 5.25 }, note: "Standard low-doc/SE" },
        { id: "m5", key: { residency: "NON_RESIDENT", segment: "PREMIER", tenure: "2" }, structure: "FIXED_THEN_VAR", fixedRate: 5.75, fixedMonths: 24, followOn: { margin: 2.99, index: "EIBOR_3M", floor: 2.99 }, note: "NR Premium" },
        { id: "m6", key: { residency: "NON_RESIDENT", segment: "STANDARD", tenure: "2" }, structure: "FIXED_THEN_VAR", fixedRate: 5.99, fixedMonths: 24, followOn: { margin: 2.99, index: "EIBOR_3M", floor: 2.99 }, note: "NR Standard" },
      ]},
      fees: {
        processingPct: 0.5, processingMin: 0, valuation: 2625, preApproval: 0, vatPct: 5,
        earlySettlement: "Residential: NIL ESF on part payment up to 25%/calendar year; else 1.05% of outstanding (incl. VAT) or AED 10,500 — whichever lower",
        partialSettlement: "Up to 25% every year (min AED 25,000)",
        lifeInsurancePct: 0.165, lifeInsuranceBasis: "PA", lifeInsuranceNote: "per annum of loan amount",
        propertyInsurancePct: 0.04, propertyInsuranceBasis: "PA", propertyInsuranceNote: "per annum of property value",
        processingFeeTiers: [
          { label: "Salaried First Sale/Resale/Buyout", pct: 0 }, { label: "Top Up / Equity Release", pct: 1.0 },
          { label: "SE/Low Doc First/Resale/Buyout", pct: 0.5 }, { label: "NR all transactions", pct: 1.0 },
        ],
        rateAdjustments: [
          { id: "ma1", label: "Green Mortgage discount (revert margin)", bps: -25 },
          { id: "ma2", label: "First-time home buyer discount (revert margin)", bps: -25 },
          { id: "ma3", label: "Pure equity release ≤ AED 7M", bps: 100, txTypes: ["EQUITY"], loanLt: 7000000 },
          { id: "ma4", label: "Pure equity release > AED 7M", bps: 150, txTypes: ["EQUITY"], loanGt: 7000000 },
        ],
        note: "Pre-approval fee waived for all segments till 30 Apr 2026; valuation refund for salaried & STL cases",
      },
      affordability: { maxDBR: 50, ccPct: 5, rentalPct: 83, bonusPct: 100, stressRecipe: { margin: 1.75, index: "EIBOR_3M" } },
      documents: [
        { name: "Passport, Visa & EID (PDF)", required: true }, { name: "Application form (signed)", required: true },
        { name: "AECB & FATCA forms", required: true }, { name: "Salary certificate (within 30 days)", required: true },
        { name: "Payslips — 6 months (if salary varies)", required: false }, { name: "Bank statements — 6 months (e-statements)", required: true },
      ],
      tat: { paDays: 3, valuationDays: 3, folDays: 5, totalDays: 18, paValidityDays: 60, folValidityDays: 30, valuationValidityDays: 60, accountOpeningDays: 0, disbursalDays: 3, transferDays: 4 },
    })],
  },
  /* ---------------- NBF · Salaried (Conventional) ---------------- */
  {
    id: "pd-nbf-sal", bankId: "b-nbf", name: "Mortgage — Salaried", loanType: "CONVENTIONAL",
    classes: ["SALARIED", "SELF_EMPLOYED"], txTypes: ["PURCHASE", "RESALE", "BUYOUT", "BUYOUT_EQUITY"],
    axes: ["employment", "tenure", "stl"],
    tags: ["Salaried", "SE", "Bundle"], createdAt: ts(-60), createdBy: "hfmm-15",
    versions: [pv({
      version: 1, status: "ACTIVE", effectiveFrom: "2025-12-03", source: "NBF mortgage pricing (bundle offer) — eff 3 Dec 2025",
      eligibility: {
        minSalary: 30000, minLoan: 500000, maxLoan: 12000000, maxAgeSalaried: 65, maxAgeSelfEmp: 70,
        minLosMonths: 6,
        incomeRecognition: { rentalPct: 83, bonusPct: 50, commissionPct: 50 },
        ltvMatrix: { "NATIONAL:1": 85, "EXPAT:1": 80, "EXPAT:2": 65 },
        ltvBands: [{ upTo: 5000000, ltv: 80 }, { upTo: 999999999, ltv: 60 }],
        ltvByEmirate: { "AJMAN": 50 },
        highRiskBands: [{ ltv: 60, sectors: ["Aviation", "Media", "Real Estate", "Advertising", "Hotels", "Restaurants"] }],
        gates: [
          { id: "g1", kind: "NATIONALITY_BLOCK", label: "Sanctioned countries (Syria incl. birthplace)", values: ["SYRIA"], hardStop: true },
          { id: "g2", kind: "FLAG", label: "Full LTV needs AED 30k salary; AED 15k OK if joint (main applicant min AED 10k fixed)", hardStop: false },
          { id: "g3", kind: "FLAG", label: "Buyout: min 3 EMIs paid on existing loan (6 for buyout+equity)", hardStop: false },
          { id: "g4", kind: "FLAG", label: "Elite status: maturity up to 70 yrs (loan > 2.5M or STL > 50k)", hardStop: false },
          { id: "g5", kind: "FLAG", label: "Alternate Income program not for equity release & refinance", hardStop: false },
        ],
        notes: ["IPA fee AED 1,050 adjusted to processing fee, refundable if declined.", "Company visit conducted."],
      },
      tenure: { maxMonths: 300 },
      grid: { cells: [
        { id: "n1", key: { employment: "SALARIED", tenure: "3", stl: "STL" }, structure: "FIXED_THEN_VAR", fixedRate: 4.50, fixedMonths: 36, followOn: { margin: 1.49, index: "EIBOR_3M", floor: 2.99 }, note: "Bundle offer" },
        { id: "n2", key: { employment: "SALARIED", tenure: "5", stl: "STL" }, structure: "FIXED_THEN_VAR", fixedRate: 4.25, fixedMonths: 60, followOn: { margin: 1.49, index: "EIBOR_3M", floor: 2.99 }, note: "Bundle offer" },
        { id: "n3", key: { employment: "SALARIED", tenure: "3", stl: "NSTL" }, structure: "FIXED_THEN_VAR", fixedRate: 4.75, fixedMonths: 36, followOn: { margin: 1.79, index: "EIBOR_3M", floor: 2.99 }, note: "Bundle offer" },
        { id: "n4", key: { employment: "SALARIED", tenure: "5", stl: "NSTL" }, structure: "FIXED_THEN_VAR", fixedRate: 4.50, fixedMonths: 60, followOn: { margin: 1.79, index: "EIBOR_3M", floor: 2.99 }, note: "Bundle offer" },
        { id: "nb1", key: { employment: "SALARIED", tenure: "2", stl: "STL", transaction: "BUYOUT" }, structure: "FIXED", fixedRate: 2.89, fixedMonths: 24, note: "Buyout" },
        { id: "nb2", key: { employment: "SALARIED", tenure: "3", stl: "STL", transaction: "BUYOUT" }, structure: "FIXED", fixedRate: 2.99, fixedMonths: 36, note: "Buyout" },
        { id: "nb3", key: { employment: "SALARIED", tenure: "5", stl: "STL", transaction: "BUYOUT" }, structure: "FIXED", fixedRate: 3.49, fixedMonths: 60, note: "Buyout" },
      ]},
      fees: {
        processingPct: 1, processingMin: 0, valuation: 2500, preApproval: 1050, vatPct: 5,
        ...
        lifeInsurancePct: 0.02358, lifeInsuranceBasis: "PM", lifeInsuranceNote: "per month of outstanding (since 15 Nov 2022)",
        propertyInsurancePct: 0.035, propertyInsuranceBasis: "PA", propertyInsuranceNote: "per annum of property value",
        processingFeeTiers: [
          { label: "Al Samy (loan ≥ 5M)", pct: 0.35 }, { label: "Priority (2.5M–5M)", pct: 0.5 },
          { label: "Other (up to 2.5M)", pct: 1.0 }, { label: "Buyout + Equity (equity component)", pct: 1.0 },
        ],
        feeFinancing: { allowed: true, pct: 6, basis: "6% DLD & broker fee (eff 11 Apr 2023)" },
        rateAdjustments: [
          { id: "na1", label: "Small-ticket low-LTV (low doc)", bps: 25, lowDoc: true },
          { id: "na2", label: "Fixed-rate case ≥ AED 10M", bps: 50, loanGt: 10000000 },
        ],
        note: "Valuation AED 2,500 + VAT standard / AED 3,625 express; buyout refunded, buyout+cashout not",
      },
      affordability: { maxDBR: 50, ccPct: 5, rentalPct: 83, bonusPct: 50, stressAddPct: 2 },
      documents: [
        { name: "Passport, Visa & EID (PDF)", required: true }, { name: "Application form (e-signed)", required: true },
        { name: "FTS consent & CIF", required: true }, { name: "Salary certificate (within 30 days)", required: true },
        { name: "Payslips — 6 months (if salary varies)", required: false }, { name: "Bank statements — 6 months (e-statements)", required: true },
        { name: "Latest CC / liability statements", required: true },
      ],
      tat: { paDays: 4, valuationDays: 3, folDays: 3, totalDays: 17, paValidityDays: 60, folValidityDays: 30, valuationValidityDays: 60, accountOpeningDays: 1, disbursalDays: 5, transferDays: 2 },
    })],
  },
  {
...
const GOLDEN_CASES: GoldenCase[] = [
  ...
  {
    id: "golden-21", name: "FAB — clean STL 3yr expat eligible",
    client: { ...baseProfile, name: "Golden · FAB STL", customerType: "EXPAT" as const, salaryTransfer: true, preferredFixedYears: 3, age: 40, monthlyIncome: 30000, monthlyLiabilities: 2000, propertyValue: 2000000, loanRequested: 1200000 },
    expected: [{ productDefId: "pd-fab-sal", verdict: "ELIGIBLE" }],
    note: "STL 3yr 3.99% + 3M EIBOR (floor 1.99%); 80% expat LTV covers 60% request; DBR with 2% CC limit.",
  },
  {
    id: "golden-22", name: "NBF — clean STL 3yr expat eligible (bundle)",
    client: { ...baseProfile, name: "Golden · NBF STL", customerType: "EXPAT" as const, salaryTransfer: true, preferredFixedYears: 3, age: 38, monthlyIncome: 35000, monthlyLiabilities: 2500, propertyValue: 1500000, loanRequested: 1000000 },
    expected: [{ productDefId: "pd-nbf-sal", verdict: "ELIGIBLE" }],
    note: "Bundle STL 3yr 4.50% (floor 2.99%); <5M value band → 80% expat LTV covers ~67% request.",
  },
  {
    id: "golden-23", name: "HSBC — clean Premier 3yr expat eligible",
    client: { ...baseProfile, name: "Golden · HSBC Premier", customerType: "EXPAT" as const, segment: "PREMIER", salaryTransfer: true, preferredFixedYears: 3, age: 42, monthlyIncome: 50000, monthlyLiabilities: 3000, propertyValue: 3000000, loanRequested: 2000000 },
    expected: [{ productDefId: "pd-hsbc-sal", verdict: "ELIGIBLE" }],
    note: "Premier 3yr 4.39% + 3M EIBOR; 80% expat LTV covers ~67% request.",
  },
  {
    id: "golden-24", name: "Mashreq campaign — Premium STL 2yr expat eligible",
