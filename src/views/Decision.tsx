        ...
        <div className="grid lg:grid-cols-12 gap-4">
          ...
          <div className="lg:col-span-4 anim-up bg-card border border-mist rounded-lg p-4 self-start">
            ...
            <div className="grid grid-cols-2 gap-3 mt-3">
              ...
              <Field label="Preferred fixed term"><Select value={profile.preferredFixedYears != null ? String(profile.preferredFixedYears) : ""} onChange={(v) => setProfile({ ...profile, preferredFixedYears: v ? Number(v) : undefined })} options={[{ v: "", l: "Best available" }, { v: "1", l: "1 year" }, { v: "2", l: "2 years" }, { v: "3", l: "3 years" }, { v: "4", l: "4 years" }, { v: "5", l: "5 years" }, { v: "7", l: "7 years" }, { v: "10", l: "10 years" }, { v: "15", l: "15 years" }, { v: "20", l: "20 years" }]} /></Field>
              <Field label="Existing loan rate"><NumInput value={profile.existingLoanRate ?? 0} onChange={(n) => setProfile({ ...profile, existingLoanRate: n || undefined })} suffix="%" /></Field>
