      ...
      <div className="bg-ink text-paper rounded-lg px-7 py-6 mb-4 anim-up relative overflow-hidden sidebar-texture">
        <div className="flex flex-wrap items-start justify-between gap-4 relative">
          <div>
            ...
            <p className="text-[13px] text-paper/70 mt-2 max-w-[560px]">8-batch operating manual. Batches 1–3 are live; every chapter also activates controls in the case engine, Rule Centre and Bank Matrix.</p>
            <div className="flex flex-wrap gap-1.5 mt-3.5">
              {["Working draft", "Foundation → Transfer", "Transaction types", "Bank submission & Huspy"].map((t) => (
